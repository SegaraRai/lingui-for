...
export type TransComponentDescriptor =
  | {
      ...
      kind: "element";
      /**
       * HTML tag name passed to `<svelte:element>`.
       */
      tag: string;
      /**
  ...
  | {
      /**
       * Renders the placeholder as a Svelte component.
       */
      kind: "component";
      /**
       * Component constructor used for the placeholder.
       */
...
export type TransRenderNode =
  ...
  | {
      ...
      kind: "component";
      /**
       * Stable key used while rendering the parsed tree in Svelte.
       */
      key: string;
      /**
 ...
 * @returns A tree of text and component nodes that can be rendered by `RenderTransNodes.svelte`.
 *
