...
const __lf_0 = __lingui_for_svelte_reactive_translation__(
  translate`ようこそ ${readerName}`,
  "translate",
);
const __lf_1 = __lingui_for_svelte_reactive_translation__(
  translate(
...
const __lf_2 = (
  <Trans>
    ...
    <span>{String(selectedPath ?? "")}</span> を確認しています。
  </Trans>
);
const __lf_3 = __lingui_for_svelte_reactive_translation__(
