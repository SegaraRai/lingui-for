...
| `lingui-for-svelte/extractor`  | `svelteExtractor(options?)` factory for `lingui.config.ts`                                                     | ✓           |
...
| `lingui-for-astro/extractor`   | `astroExtractor(options?)` factory for `lingui.config.ts`                                                      | ✓           |
